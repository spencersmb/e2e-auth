...
export const renderField = ({ input, label, type,  meta: { pristine, touched, error , invalid} }) => {
	...
	const groupClass = !pristine || touched ? (invalid ? 'form-group has-error has-feedback':'form-group has-success has-feedback') : 'form-group';

	// Construct form-control class depending on form state
	const inputClass = !pristine || touched ? (invalid ? 'form-control form-control-danger':'form-control form-control-success') : 'form-control';
